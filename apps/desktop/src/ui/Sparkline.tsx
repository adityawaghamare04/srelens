...
export function Sparkline({
  ...
  return (
    ...
    >
      ...
      <line x1="0" y1={height - 0.5} x2={width} y2={height - 0.5} className="fl-sparkline__grid" />
      <line x1="0" y1={pad + innerH / 2} x2={width} y2={pad + innerH / 2} className="fl-sparkline__grid" />
